...
`09_action_selection_storytelling` wins locally because it is the strongest combination of module gap closure, actionability, and low current-blocker drag.
