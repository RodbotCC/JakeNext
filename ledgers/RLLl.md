...
| `ledgers/TCLl.md` | 78 | 16 | 70 | 24 | 84 | 90 | 78 | 46 | continuity surface and outcome memory |
| `ledgers/MACRO_LEDGER.md` | 82 | 18 | 78 | 22 | 84 | 92 | 80 | 48 | navigation spine and phase truth |
| `ledgers/RLLl.md` | 86 | 18 | 88 | 30 | 86 | 94 | 90 | 56 | chooser law and comparator contract |
...
| `pieces/SWEEP_POLICY.md` | 88 | 12 | 92 | 24 | 90 | 92 | 86 | 60 | Governs the highest-bandwidth behavioral signal source; high compounding leverage because every sweep produces training data; low counterfeit risk because it is grounded in actual behavior; strong momentum alignment with current build phase |
| `Framed/` (product directory) | 90 | 14 | 94 | 40 | 88 | 86 | 88 | 68 | Live product app with real shipped features; high compounding leverage as the glue layer; higher cognitive cost than a doc but justified; strong identity alignment as the visible autonomy substrate |
...
| `structural_health` | `AGENTS.md`; `ledgers/RLLl.md`; `chooser/CHOOSER_POLICY.md`; `chooser/MODULE_PROGRESS.md`; `identity/SYLVIA.md` |
...
| `clarify_the_architecture` | `chooser/CHOOSER_POLICY.md`; `AGENTS.md`; `ledgers/RLLl.md`; `chooser/MODULE_PROGRESS.md`; `identity/NORTH_STAR.md` |
| `build_the_ratio_lattice` | `source/JakeRL.txt`; `chooser/CHOOSER_POLICY.md`; `ledgers/RLLl.md`; `skills/codex-sylvia-chooser/SKILL.md`; `canon/JAKE_PERSONAL_ORACLE_FOUNDATION.md` |
