...
- When a new skill is added: update this FCL, update `ledgers/FDL.md` if structure changed, update `ledgers/MACRO_LEDGER.md` if the skill changes top-level navigation, and log to `ledgers/TCL.md`
